          ...
          <div className="flex flex-col md:justify-center bg-[#0E8388] pt-[100px] px-[50px] md:flex md:flex-row    bg-no-repeat bg-cover">
                  ...
                  <form onSubmit={handleSubmit} className="flex justify-center">
                    <div className="hidden md:block md:flex  bg-white w-full max-w-md h-[50px] items-center px-[10px] rounded-xl  md:self-start self-center ">
                      ...
                      <div className="flex items-center justify-center">
                        <button type="submit" className="btn btn-primary bg-white border-0 hover:bg-white">
            ...
            <div className="md:hidden md:mb-[0px] mb-12 flex bg-white w-[85%] h-[50px] items-center px-[10px] rounded-xl  md:self-start self-center ">
              ...
              <div className="flex gap-2">
                ...
                <div>
                  <input className=" w-full outline-none" type="text" placeholder="Where?" />
                </div>
              </div>
              <div>
                <BsArrowRightSquareFill color="red" size={28} />
                        ...
                        <img
                          ...
                          src={
                            city.picture.startsWith('https')
                              ? city.picture
                              : `${import.meta.env.VITE_BACKEND_URL}/uploads/${city.picture}`
                          }
                        />
                ...
                <div className="w-[100%]  py-6">
                  <div className="flex gap-4  w-full items-center justify-center">
                    ...
                    {eventCategory.length < 1 && (
                      <div className="text-2xl font-bold text-red-400">Data Category Not Found!</div>
                    )}
                  </div>
                </div>
              </div>
                        ...
                        <img
                          ...
                          src={
                            patner.picture.startsWith('https')
                              ? patner.picture
                              : `${import.meta.env.VITE_BACKEND_URL}/uploads/${patner.picture}`
                          }
                        />
                      </div>
                    </React.Fragment>
