...
function Profil() {
  ...
  const editProfile = async (values) => {
    ...
    Object.keys(values).forEach((key) => {
      if (values[key]) {
        if (key === 'birthDate') {
          form.append(key, moment(values[key], 'YYYY-MM-DD').format('DD-MM-YYYY'));
        } else {
          ...
          >
            {({ handleChange, handleBlur, handleSubmit, values }) => (
              <form
                ...
                className="w-full h-full rounded-[30px] flex pb-[50px]  justify-center bg-white mt-[0px] overflow-hidden"
              >
                <div className="px-[50px] mt-[0px] md:mt-[75px]  flex flex-col flex-1 w-[100%] md:w-full">
                  ...
                  <div className="flex mt-[50px]">
                    <div className="flex flex-col gap-[30px] w-full">
                      ...
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1">
                          <div className="flex gap-4">
                            ...
                            {!editUsername && (
                              <div>
                                <button onClick={() => setEditUsername(true)} className="text-accent font-bold">
                                  Edit
                                </button>
                              </div>
                            )}
                      ...
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1">
                          <div className="flex gap-4">
                            ...
                            {!editEmail && (
                              <div>
                                <button onClick={() => setEditEmail(true)} className="text-accent font-bold">
                                  Edit
                                </button>
                              </div>
                            )}
                      ...
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1">
                          <div className="flex gap-4">
                            ...
                            {!editPhoneNumber && (
                              <div>
                                <button onClick={() => setEditPhoneNumber(true)} className="text-accent font-bold">
                                  Edit
                                </button>
                              </div>
                            )}
                        ...
                        <div className="flex-1">
                          <div className="flex gap-4">
                            <label className="flex gap-2 items-center">
                              <Field type="radio" className="radio radio-accent" name="gender" value="0" />
                              <span>Male</span>
                            </label>
                            <label className="flex gap-2 items-center">
                              <Field type="radio" className="radio radio-accent" name="gender" value="1" />
                              <span>Female</span>
                            </label>
                          </div>
                        </div>
                      ...
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1">
                          <div className="flex gap-4">
                            ...
                            {!editBirthdate && (
                              <div>
                                <button onClick={() => setEditBirthdate(true)} className="text-accent font-bold">
                                  Edit
                                </button>
                              </div>
                            )}
                      ...
                      <div>
                        <button type="submit" className="btn btn-accent max-w-[315px] w-full">
                          Save
                        </button>
                      </div>
                    </div>
                ...
                <div className="mt-[100px] p-20 items-center hidden md:block justify-center border-l-2 border-[#C1C5D025%]">
                      ...
                      <div className="border rounded-full overflow-hidden w-full h-full">
                        ...
                        {selectedPicture && (
                          <div className="w-full h-full relative">
                            <img className="object-cover w-full h-full" src={pictureURI} alt="profil" />
